...
|---|---|
| `docs/open-issues.md` | **Read before starting anything.** 27 issues — 19 closed (one partly), 8 open. The closed ones record decisions you would otherwise re-litigate, and several record a bug's *shape* rather than just its fix. |
