...
|---|---|
| `docs/open-issues.md` | **Read before starting anything.** 14 issues — 9 closed (one partly), 5 open. The closed ones record decisions you would otherwise re-litigate, and several record a bug's *shape* rather than just its fix. |
