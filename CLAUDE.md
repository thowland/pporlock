...
|---|---|
| `docs/open-issues.md` | **Read before starting anything.** 20 issues — 13 closed (one partly), 7 open. The closed ones record decisions you would otherwise re-litigate, and several record a bug's *shape* rather than just its fix. |
...
**Current baseline:** daemon 1916, web 494, extension 256, mcp 134, E2E 28. Coverage: daemon 93%, `engine/` 96.8%, web 94.5%, extension 93%, mcp 98.9%.
